using TodoTemplateDevOps.Client.Shared.Shared;
#if BlazorServer
...
namespace TodoTemplateDevOps.Client.Web;
...
public class Program
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("TodoTemplateDevOps.Client.Shared.wwwroot.appsettings.json"));
