...
using TodoTemplateDevOps.Server.Api.Models.Emailing;

namespace TodoTemplateDevOps.Server.Api.Controllers;
...
public partial class AuthController : AppControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("TodoTemplateDevOps.Server.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("TodoTemplateDevOps.Server.Api.Resources.ResetPassword.cshtml",
